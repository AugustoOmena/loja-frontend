...
import {
  useFrete,
  cartItemsToFreteItens,
} from "@/store/features/checkout/hooks/useFrete";
import { ShippingSection } from "@/store/features/checkout/components/ShippingSection";
import { AddressForm } from "@/store/features/checkout/components/AddressForm";
...
export const Checkout = () => {
  ...
  const handleSelectShipping = (op: OpcaoFrete, _: number) => {
